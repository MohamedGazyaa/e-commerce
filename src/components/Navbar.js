  ...
  return (
    <>
      ...
      <div className="flex justify-around items-center w-full">
        ...
        <div className="flex flex-row it ems-center">
          <Tooltip content="Sign Out" placement="bottom">
          <button onClick={()=>dispatch(logout())} className=" font-inter text-base font-medium tracking-normal loading-none text-center mr-4">
            Logout
          </button>
          </Tooltip>
      ...
      <div className="bg-black p-4 w-full flex justify-around">
        <div className="text-white font-inter text-base font-medium tracking-normal loading-none text-center">
          50% OFF
        </div>
        <div className="text-white font-inter text-base font-medium tracking-normal loading-none text-center">
